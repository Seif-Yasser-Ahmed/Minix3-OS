...
int do_start_scheduling(message *m_ptr)
{
	...
	if (rmp->endpoint == rmp->parent)
	{
		...
		rmp->priority = USER_Q;
		rmp->time_slice = DEFAULT_USER_TIME_SLICE; // 3mlna initialization lel timeSlice
	...
	case SCHEDULING_INHERIT:
		...
		rmp->priority = MAX_USER_Q; //////////////// assigned priority to the max
...
int do_nice(message *m_ptr)
{
	...
	old_quantum = rmp->quantum; //////////////////////////////////// 3mlna old quantum bt3t el process stored
